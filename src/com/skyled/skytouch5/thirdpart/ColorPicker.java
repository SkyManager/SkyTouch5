...
public class ColorPicker extends View {
	...
	private Paint mColorWheelPaintBack;
	...
	private void init(AttributeSet attrs, int defStyle) {
		...
		mColorWheelPaint.setPathEffect(new DashPathEffect(new float[] { 2, 3}, 0));
		
		mColorWheelPaintBack = new Paint(Paint.ANTI_ALIAS_FLAG);
		mColorWheelPaintBack.setColor(Color.BLACK);
		mColorWheelPaintBack.setStyle(Paint.Style.STROKE);
		mColorWheelPaintBack.setStrokeWidth(mColorWheelThickness+2);



		mPointerHaloPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
		mPointerHaloPaint.setColor(Color.parseColor("#33b5e5"));
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawOval(mColorWheelRectangle, mColorWheelPaintBack);
	...
	private void animProgress(int time)
	{
			this.mColorWheelThickness=time;
			mColorWheelPaint.setStrokeWidth(mColorWheelThickness);
			mColorWheelPaintBack.setStrokeWidth(mColorWheelThickness+4);
			invalidate();
	}
